// Member Inner Class - Computer Example
//
// Problem: Write a Java program to demonstrate a member inner class.
...
public class MemberInnerClassComputer {
    public static void main(String[] args) {
        Computer avdeshComputer = new Computer();
        avdeshComputer.processorDetails();
    }
}