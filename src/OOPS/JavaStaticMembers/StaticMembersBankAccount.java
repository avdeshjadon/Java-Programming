...
//
// Problem: Write a Java program to demonstrate use of static members in a class.
//
...
public class StaticMembersBankAccount {
    public static void main(String[] args) {
        BankAccount.setBankName("National Bank");
        BankAccount.setInterestRate(3.5);

        BankAccount avdeshAccount = new BankAccount("123456789", 1000.00);
        BankAccount amanAccount = new BankAccount("987654321", 2000.00);

        avdeshAccount.printDetails();
        System.out.println();
        amanAccount.printDetails();
    }
}